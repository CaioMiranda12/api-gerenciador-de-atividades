...
| `PUT` | `/activities/reorder` | Reordena a posição das atividades recebendo uma lista de ActivityDTO com a nova ordem |
...
#### - Antes de rodar a aplicação, é necessário criar o banco de dados local:

#### - Certifique-se de ter o PostgreSQL instalado.

#### - Acesse o terminal do PostgreSQL ou utilize o pgAdmin.

#### - Crie o banco de dados com o nome gerenciador-atividades e configure usuário e senha: (nome: postgres, senha: postgres).
